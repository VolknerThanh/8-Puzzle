...
namespace Puzzle
{
    class PuzzleMap
    {
        ...
        public static int vtx_null, vty_null;
        public int VTX { set { vtx_null = value; } get { return vtx_null; } }
        public int VTY { set { vty_null = value; } get { return vty_null; } }
        public void FindTheNullPosition()
        {
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
